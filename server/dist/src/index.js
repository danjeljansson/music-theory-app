...
app.get("/", (0, validate_dto_1.default)(quiz_validator_1.default), (request, response) => {
...
app.put("/update/:id", id_param_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
app.get("/all/:id", id_param_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
...
app.delete("/delete/:id", id_param_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const question = yield model_1.default.findOne({ where: { id: id } });
        if (!question) {
